...
qP = Continuous1DFunction( qPochhammerSymbol(1.280000*nanometers, 5), 0*nanometers, 1.280000*nanometers)
...
platform = Platform.getPlatformByName('CUDA')  # Now running on CPU!

prop = dict(CudaPrecision='mixed',CudaDeviceIndex='0,1') # Now running on CPU!

# Create the Simulation object
sim = Simulation(modeller.topology, system, integrator, platform)

# print(platform.getPropertyValue(sim.context,'CudaDeviceIndex')) # Now running on CPU!
