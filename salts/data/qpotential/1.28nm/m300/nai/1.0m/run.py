...
ff = ForceField("nonbonded_custom.xml") # this will create a CustomNonbondedForce
...
qP = Continuous1DFunction( qPochhammerSymbol(1.280000*nanometers, 300), 0*nanometers, 1.280000*nanometers)
