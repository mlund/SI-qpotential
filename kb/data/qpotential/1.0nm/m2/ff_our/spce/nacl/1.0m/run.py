...
ff = ForceField("test_nonbonded.xml") # this will create a NonbondedForce
...
ff = ForceField("test_nonbonded_custom.xml") # this will create a CustomNonbondedForce
...
qP = Continuous1DFunction( qPochhammerSymbol(1.0*nanometers, 2), 0*nanometers, 1.0*nanometers)
